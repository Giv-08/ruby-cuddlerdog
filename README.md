...
is to create a full-stack web application using Ruby and Ruby on Rails that allows users to rent dogs for a specific period, providing an engaging and easy-to-use platform for both dog renters (customers) and dog owners (service providers). The app bridges the gap between individuals who love dogs but cannot commit to owning one and dog owners who want to share their pets with others in a safe and managed environment.

How to run the app:
# :earth_asia: Install Ruby (if not already installed)
...
```
### :ringed_planet: How to clone this project
```
git clone https://github.com/Giv-08/ruby-cuddlerdog.git
```
### :computer: Run the Application
...
ruby <filename>.rb
```
## :desktop_computer: Access the Application
...
### :abacus: Tech Stack for Full-Stack App
...
### :poodle: DogCuddler allows you to search by filtering dog breeds and min/max prices:
Feature Overview:
...
### :dog2: DogCuddler allows you to edit or update dog details:
Feature Overview:
...
### :service_dog: DogCuddler allows you to view the dashboard, including approve or decline the rentals:
Feature Overview:
...
---------------------------------------------------------------------------------------------------
<img width="1789" alt="banner" src="https://github.com/user-attachments/assets/813ea991-2508-4584-bbc5-3a62c7914110">

---------------------------------------------------------------------------------------------------
### :woman_technologist: Developed by Le Wagon Students
* Debbie Lee
* Chutima Puthachon
* Kara Yu
* Manisha Parajuli
